$(function () {
  ...
  function header1() {
    $("#header-setting").attr(
      "class",
      "navbar navbar-expand fixed-top color-header bg-theme1"
    );
  }
  ...
  function header2() {
    $("#header-setting").attr(
      "class",
      "navbar navbar-expand fixed-top color-header bg-theme2"
    );
  }
  ...
  function header3() {
    $("#header-setting").attr(
      "class",
      "navbar navbar-expand fixed-top color-header bg-theme3"
    );
  }
  ...
  function header4() {
    $("#header-setting").attr(
      "class",
      "navbar navbar-expand fixed-top color-header bg-theme4"
    );
  }
  ...
  function header5() {
    $("#header-setting").attr(
      "class",
      "navbar navbar-expand fixed-top color-header bg-theme5"
    );
  }
  ...
  function header6() {
    $("#header-setting").attr(
      "class",
      "navbar navbar-expand fixed-top color-header bg-theme6"
    );
  }
  ...
  $(document).ready(function () {
    $("#default-header").click(function () {
      $("#header-setting").removeClass(
        "color-header bg-theme1 bg-theme2 bg-theme3 bg-theme4 bg-theme5 bg-theme6"
      );
    });

    $("#default-sidebar").click(function () {
      $("#sidebar-wrapper").removeClass(
        "bg-theme bg-theme1 bg-theme2 bg-theme3 bg-theme4 bg-theme5 bg-theme6"
      );
    });
  });
});
